...
public class Dreptunghi extends HexColorValidator implements Shape {
	...
	Dreptunghi(String culoare, int contur, double lungime, double latime) {
		...
		if (contur > 0) {
			...
			throw new IllegalArgumentException("Contur de valoare negativa");
		}
		...
		if ((lungime > 0) && (latime > 0)) {
			...
			throw new IllegalArgumentException("Dimensiuni de valoare negativa");
		}
